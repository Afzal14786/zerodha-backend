...
import {generateAccountNumber, generateBankName, generateDematNumber, generatePanCardNumber, generateSupportCode, generateUserId} from "../../helper/user.helper.js";
import sendOtpToPhone from "../../helper/sendOtpToPhone.js";
...
export const phoneSignUp = async(req, res)=> {
    ...
    // save otp to Redis (expire within 5 minutes)
    await redis.setEx(`otp:phone${phone}`, 300, otp);
...
/**
 * setup the nodemailer and twilio
 * status: yet pending
 */